...
print("MNIST的数据train_images={},test_images={},train_labels={}".format(mnist.train.images.shape,mnist.test.images.shape,mnist.train.labels.shape))
...
def backward(probs, labels, x1, x2):
    ...
    """
    print("probs={},labels={}".format(probs, labels))
...
print("总训练数据num_train:={},批次大小batch_size:{},批量处理num_batches:{}".format(num_train,batch_size,num_batches))
